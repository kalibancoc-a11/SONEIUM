...
def activity(bot: Bot, amount_input):
    ...
    base_balance = base_onchain.get_balance(address=bot.account.address)
    ...
    random_sleep(2, 3)
    bot.ads.page.get_by_role('heading', name='Base').click()
    random_sleep(2, 3)
    ...
    for _ in range(60):
        ...
        if balance_after > balance_before:
            ...
            excel_report.set_cell(f'BASE Bridge', f'{deposit_amount:.5f}')
